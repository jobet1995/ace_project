...
(function ($) {
  ...
  function initCounters() {
    ...
    function animateCounter(element) {
      ...
      const duration = parseInt($element.attr('data-duration'), 10) || 2000;
  ...
  function initTestimonialCarousel() {
    ...
    if (typeof Swiper !== 'undefined') {
      ...
      const _testimonialSwiper = new Swiper('.testimonials-swiper', {
        slidesPerView: 1,
        spaceBetween: 30,
        loop: true,
        autoplay: {
  ...
  function initPartnerCarousel() {
    ...
    if (typeof Swiper !== 'undefined') {
      ...
      const _partnerSwiper = new Swiper('.partners-swiper', {
        slidesPerView: 2,
        spaceBetween: 30,
        loop: true,
        autoplay: {
